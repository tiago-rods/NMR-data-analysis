...
def process_all_files(
    ...
    """
    asics_formatter = ASICSFormatter(str(output_base_dir))
    magmet_formatter = MagMetFormatter(str(output_base_dir))
    nmranalysis_formatter = NmRanalysisFormatter(str(output_base_dir))
