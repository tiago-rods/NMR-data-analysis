...
from src.processors.factory_processor import FactoryFormatter

class JDXFormatter(FactoryFormatter):
    def format(self, jdx_data_list: List[Dict[str, Any]], experiment_names: List[str], sample_type: str = None) -> pd.DataFrame:
        """
